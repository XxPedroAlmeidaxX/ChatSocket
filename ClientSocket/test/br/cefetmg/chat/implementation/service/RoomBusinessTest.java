...
public class RoomBusinessTest {
     ...
     * Objetivo: lançar uma exeção 
     */
    @Test
    public void testInsertRoom1() throws Exception {
     ...
     */
    @Test
    public void testInsertRoom2() throws Exception {
        System.out.println("insertRoom");
        Room r = null;
        RoomBusiness instance = null;
        Room expResult = null;
     ...
     */
    @Test
    public void testInsertRoom3() throws Exception {
        System.out.println("insertRoom");
        Room r = null;
        RoomBusiness instance = null;
        Room expResult = null;
     ...
     */
    @Test
    public void testInsertRoom4() throws Exception {
        System.out.println("insertRoom");
        Room r = null;
        RoomBusiness instance = null;
        Room expResult = null;
    ...
    /**
     * Test of removeUserRoom method, of class RoomBusiness.
     */
    @Test
    public void testRemoveUserRoom() throws Exception {
        System.out.println("removeUserRoom");
        Long idUser = null;
        Long idRoom = null;
        RoomBusiness instance = null;
        Room expResult = null;
        Room result = instance.removeUserRoom(idUser, idRoom);
        assertEquals(expResult, result);
        // TODO review the generated test code and remove the default call to fail.
        fail("The test case is a prototype.");
    }
