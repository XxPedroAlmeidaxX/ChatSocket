...
ALTER TABLE "User" ADD CONSTRAINT "Key2" PRIMARY KEY ("ipUser","nameUser")
;
...
ALTER TABLE "User-Room" ADD CONSTRAINT "Key4" PRIMARY KEY ("idRoom","idUser","nameUser")
;
-- Create relationships section ------------------------------------------------- 

ALTER TABLE "Message" ADD FOREIGN KEY ("targetMessage", "nameUser") REFERENCES "User" ("ipUser", "nameUser") ON DELETE NO ACTION ON UPDATE NO ACTION
;

ALTER TABLE "Message" ADD FOREIGN KEY ("senderUser", "nameTarget") REFERENCES "User" ("ipUser", "nameUser") ON DELETE NO ACTION ON UPDATE NO ACTION
;

ALTER TABLE "Message" ADD FOREIGN KEY ("room") REFERENCES "Room" ("idRoom") ON DELETE NO ACTION ON UPDATE NO ACTION
;

ALTER TABLE "User-Room" ADD FOREIGN KEY ("idRoom") REFERENCES "Room" ("idRoom") ON DELETE NO ACTION ON UPDATE NO ACTION
;

ALTER TABLE "User-Room" ADD FOREIGN KEY ("idUser", "nameUser") REFERENCES "User" ("ipUser", "nameUser") ON DELETE NO ACTION ON UPDATE NO ACTION
;