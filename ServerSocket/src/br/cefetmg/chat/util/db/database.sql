...
ALTER TABLE Message ADD FOREIGN KEY (targetMessage) REFERENCES Users (idUser) ON DELETE CASCADE ON UPDATE NO ACTION
;

ALTER TABLE Message ADD FOREIGN KEY (senderUser) REFERENCES Users (idUser) ON DELETE CASCADE ON UPDATE NO ACTION
;

ALTER TABLE Message ADD FOREIGN KEY (room) REFERENCES Room (idRoom) ON DELETE CASCADE ON UPDATE NO ACTION
;

ALTER TABLE UsersRoom ADD FOREIGN KEY (idRoom) REFERENCES Room (idRoom) ON DELETE CASCADE ON UPDATE NO ACTION
;

ALTER TABLE UsersRoom ADD FOREIGN KEY (idUser) REFERENCES Users (idUser) ON DELETE CASCADE ON UPDATE NO ACTION
;